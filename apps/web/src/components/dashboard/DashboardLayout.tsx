...
const navItems = [
  { icon: LayoutDashboard, label: 'Bảng điều khiển', href: '/hr/bang-dieu-khien' },
  { icon: Users, label: 'Kanban ứng viên', href: '/hr/kanban', badge: 8 },
  { icon: Briefcase, label: 'Tin tuyển dụng', href: '/hr/tin-tuyen-dung', badge: 3 },
  { icon: Users, label: 'Ứng viên', href: '/hr/ung-vien' },
  { icon: CalendarCheck, label: 'Lịch phỏng vấn', href: '/hr/lich-phong-van' },
  { icon: BarChart3, label: 'Báo cáo', href: '#' },
];

const adminItems = [
  { icon: UserCircle, label: 'Quản lý người dùng', href: '/admin/user-management' },
  { icon: Building2, label: 'Phòng ban', href: '/admin/department-management' },
  { icon: Cpu, label: 'Cấu hình AI', href: '/admin/ai-configuration' },
  { icon: Settings, label: 'Thông tin công ty', href: '/admin/company-profile' },
];
